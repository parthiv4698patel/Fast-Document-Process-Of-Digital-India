                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                           Vehicle Sales Affidavite 
                            </header>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal " action="vehiclesales_pro.jsp" method="post">
                                   <center> <h3>Vehicle Giver Detail</h3> </center> 
                                    ...
                                    <div class="form-group ">
                                       ...
                                       <center> <h3>Vehicle Acceptor Detail</h3> </center> 
