...
int i=0;  
String query1 = "SELECT * FROM tbl_vehicle WHERE client_id='"+client_id+"'";
//out.print(query1);
...
if(i>0)
{
    response.sendRedirect("vehiclesales.jsp?already=1");
}
    else{

    String query = "insert into tbl_vehicle(advocate_id,client_id,seller_name,seller_email,seller_phone,seller_add,seller_pincode,buyer_name,buyer_email,buyer_phone,buyer_add,buyer_pincode) values('"+ad_id+"','"+session.getAttribute( "theName3" )+"','"+oname+"','"+oemail+"','"+ophone+"','"+oadd+"','"+opin+"','"+rname+"','"+remail+"','"+rphone+"','"+radd+"','"+rpin+"')";
    out.print(query);
...
/*
	...
	response.sendRedirect("inform_search_advovehicle.jsp");
