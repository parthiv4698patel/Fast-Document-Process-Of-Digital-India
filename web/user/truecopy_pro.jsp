...
int i=0;  
String query1 = "SELECT * FROM tbl_truecopy WHERE client_id='"+client_id+"'";
//out.print(query1);
...
if(i>0)
{
    response.sendRedirect("truecopy.jsp?already=1");
}
    else{

    String query = "insert into tbl_truecopy(advocate_id,client_id,t_name,t_email,t_phone,t_add,t_pincode) values('"+ad_id+"','"+session.getAttribute( "theName3" )+"','"+oname+"','"+oemail+"','"+ophone+"','"+oadd+"','"+opin+"')";
    out.print(query);
...
/*
	...
	response.sendRedirect("inform_search_advotrue.jsp");
