...
<%
    ...
    String type="rent_idproof";
 

Class.forName("com.mysql.jdbc.Driver").newInstance ();
connection = DriverManager.getConnection(connectionURL);
statement = connection.createStatement();
String rent_idproof=null;

String query = "insert into tbl_rent_doc(user_id,image_name,type) values('"+session.getAttribute( "theName3" )+"','"+saveFile+"','"+type+"')";
...
response.sendRedirect("rent_doc.jsp");
statement.close();
connection.close();
