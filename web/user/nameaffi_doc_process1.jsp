...
<%
    ...
    String type="realname_doc";
 

Class.forName("com.mysql.jdbc.Driver").newInstance ();
connection = DriverManager.getConnection(connectionURL);
statement = connection.createStatement();
String realname_doc=null;

String query = "insert into tbl_nameaffi_doc(user_id,image_name,type) values('"+session.getAttribute( "theName3" )+"','"+saveFile+"','"+type+"')";
...
response.sendRedirect("nameaffi_doc.jsp");
statement.close();
connection.close();
