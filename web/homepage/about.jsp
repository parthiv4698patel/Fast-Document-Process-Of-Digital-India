	...
	<section class="top-bar">
		<div class="container">
			...
			<div class="left-text pull-left">
				<p><span>Support Us :</span> parthiv46patel@mail.com</p>
			</div> <!-- /.left-text -->
			...
			<div class="row">
				<div class="col-lg-5 col-md-12">
					<div class="full-sec-content mb-md-30">
						...
						<h3>We Provide Notary <br> Service </h3>
						<br>
                                                <p>Rent Agreement <br>Name Change Affidavit<br>vehicle sales Affidavit<br>True Copy</p>
					</div>
				</div>
