...
%>  
 ...
 <div class="panel panel-default">
   ...
   <%
String query = "select * from tbl_truecopy  WHERE advocate_id='"+session.getAttribute( "theName3" )+"' ";
...
while(rs.next())
{
    ...
    <td><%=rs.getString("t_name").toString() %></td>
       
      
       <td><a href="detail_truecopy.jsp?id=<%=rs.getString("client_id").toString() %> && advocate_id=<%=session.getAttribute( "theName3" )%>">Details</a></td>
