                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                ...
                                <form class="cmxform form-horizontal " action="profile_process1.jsp" method="post">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                           <input type="text" class="form-control " name="ph_no" pattern="^\d{10}$" value="<% out.print(phno); %>" maxlength="10"  oninvalid="this.setCustomValidity('Enter 10 digit number')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="address" maxlength="150"  class="form-control" required="required" oninvalid="this.setCustomValidity('please enter your address')"><% out.print(addrs); %></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
