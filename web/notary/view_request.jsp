...
%>  
 ...
 <div class="panel panel-default">
  ...
  Rentagreement list
   ...
   <%
String query = "select * from tbl_rent  WHERE advocate_id='"+session.getAttribute( "theName3" )+"' ";
//out.print(query);
...
while(rs.next())
{
    ...
    <td><%=rs.getString("owner_name").toString() %></td>
       <td><%=rs.getString("rent_name").toString() %></td>
       <td><a href="detail_rentagree.jsp?id=<%=rs.getString("client_id").toString() %> && advocate_id=<%=session.getAttribute( "theName3" )%>">Details</a></td>
