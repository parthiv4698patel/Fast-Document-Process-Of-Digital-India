...
String query = "delete  from tbl_vehicle where client_id='"+client_id+"' and advocate_id='"+advo_id+"' ";
out.print(query);
statement.executeUpdate(query);


String query2 = "select * from tbl_vehicle_doc where user_id='"+client_id+"' ";
out.print(query2);
...
String query1 = "delete  from tbl_vehicle_doc where user_id='"+client_id+"' ";
out.print(query1);

statement.executeUpdate(query1);

response.sendRedirect("view_vehicle.jsp?del=success");
%>