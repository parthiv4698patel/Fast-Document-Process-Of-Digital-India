...
String query = "SELECT * FROM tbl_nameaffidavite WHERE advocate_id='"+session.getAttribute( "theName3" )+"' and client_id='"+client_id+"'  ";
//out.print(query);
...
while(rs.next())
    {
       ...
       own_name=rs.getString("n_name").toString();
       own_email=rs.getString("n_email").toString();
       own_phone=rs.getString("n_phone").toString();
       own_add=rs.getString("n_add").toString();
       own_pin=rs.getString("n_pincode").toString();
...
<body>
 ...
 <div class="panel panel-default">
    ...
    <tr><th>Client id</th><td><% out.print(cl_id); %></td></tr>
        ...
        <tr><th>Phone Number</th><td><% out.print(own_phone); %></td></tr>
        <tr><th>Address</th><td><% out.print(own_add); %></td></tr>
   <tr><th>Pincode</th><td><% out.print(own_pin); %></td></tr>
...
String query1 = "SELECT * FROM tbl_nameaffi_doc WHERE user_id='"+cl_id+"'   ";
//out.print(query1);
//out.print(Id);
...
<center><p style="color:blue">If Process Is Completed Then, <a href="nameaffi_delete.jsp?id=<% out.print(client_id); %>&&adv_id=<% out.print(advo_id);%>" style="color: red">Click Here</a></p> </center>
