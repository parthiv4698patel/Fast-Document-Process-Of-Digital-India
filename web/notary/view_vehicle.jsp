...
%>  
 ...
 <div class="panel panel-default">
   ...
   <%
String query = "select * from tbl_vehicle  WHERE advocate_id='"+session.getAttribute( "theName3" )+"' ";
...
while(rs.next())
{
    ...
    <td><%=rs.getString("seller_name").toString() %></td>
       <td><%=rs.getString("buyer_name").toString() %></td>
       
       <td><a href="detail_vehicle.jsp?id=<%=rs.getString("client_id").toString() %> && advocate_id=<%=session.getAttribute( "theName3" )%>">Details</a></td>
