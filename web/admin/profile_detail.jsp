                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                ...
                                <form class="cmxform form-horizontal " action="profile_process.jsp" method="post">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control " name="e_mail" value="<% out.print(e_mail); %> " disabled>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                           <textarea class="form-control " name="address"  maxlength="150" oninvalid="this.setCustomValidity('please enter your address')"><% out.print(addrs); %></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
