...
<div class="brand">
    <a href="index.jsp" class="logo">
        ADMIN &nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-user" style="color:white"></i>
    </a>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a href="../admin/profile_detail.jsp">
                ...
                <li class="sub-menu">
                    <a href="list_advocate.jsp">
                        <i class="fa fa-list"></i>
                        <span>List of Advocate</span>
                    </a>
                    
                </li>
                <li>
                    <a href="list_client.jsp">
                        <i class="fa fa-list"></i>
                        <span>List of Client</span>
                    </a>
                </li>
                <li>
                    <a href="../admin/main_changepsw.jsp">
                        <i class="fa fa-key"></i>
